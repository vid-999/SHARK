...
class MiniLMModuleTester:
    ...
    def create_and_check_module(self, dynamic, device):
        ...
        minilm_mlir, func_name = mlir_importer.import_mlir(is_dynamic=dynamic, tracing_required=True)
        shark_module = SharkInference(minilm_mlir, func_name, device=device, mlir_dialect="linalg")
