...
class DistilBertModuleTester:
    ...
    def create_and_check_module(self, dynamic, device):
        ...
        mlir_module, func_name = mlir_importer.import_mlir(is_dynamic=dynamic, tracing_required=True)
        shark_module = SharkInference(mlir_module, func_name, device=device, mlir_dialect="linalg")
...
class DistilBertModuleTest(unittest.TestCase):
    ...
    @pytest.mark.skip(reason="torch.aten.view operation marked illegal")
